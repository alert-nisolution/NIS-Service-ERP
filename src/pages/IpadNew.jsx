...
function BottomNav({ active, onChange }) {
  const tabs = [
    ...
    { key:'calendar',  label:'ปฏิทิน',   icon: <svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg> },
    ...
    { key:'notes',     label:'โน้ต',     icon: <svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg> },
      ...
      <div style={iPadFrame}>
        {!user ? (
          ...
          <>
            ...
            {navTab === 'calendar'  && <CalendarView   user={user} />}
            {navTab === 'notes'     && <NotesView      user={user} />}
